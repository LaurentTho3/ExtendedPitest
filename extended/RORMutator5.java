...
class RORMethodVisitor5 extends AbstractJumpMutator {
  ...
  static {
    ...
    MUTATIONS.put(Opcodes.IFGE, new Substitution(Opcodes.IFNE, 
        "Replace greater or equal by different"));
